...
const Journey = () => {
  ...
  return (
    <div name="journey" className=' w-full h-full bg-[#0a192f] text-gray-300 py-32'>
        <div className=' flex flex-col justify-center items-center w-full h-full'>
            <div className="max-w-[1000px] w-full px-4 grid gap-8">
                <div className="sm:text-left pb-8 pl-4 pl-[37.5%]">
                    <p className="text-4xl font-bold inline border-b-4 border-pink-600">Journey</p>
