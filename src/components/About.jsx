          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="glass-card p-6 sm:p-8 rounded-3xl border border-slate-800">
              ...
              <div className="space-y-4 text-slate-300 leading-relaxed text-sm sm:text-base">
                <p>
                  I am a results-driven <strong className="text-slate-100">Senior Software Engineer</strong> with 5+ years of experience engineering high-scale mobile (<strong className="text-cyan-300">React Native</strong>) and full-stack (<strong className="text-indigo-300">React, Next.js, Nuxt 3, Spring Boot</strong>) architectures.
                </p>
                <p>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="glass-card p-5 rounded-2xl border border-slate-800/80">
                <h4 className="text-base font-bold text-cyan-300 mb-2">Mobile & Frontend Architecture</h4>
              ...
              <div className="glass-card p-5 rounded-2xl border border-slate-800/80">
                <h4 className="text-base font-bold text-indigo-300 mb-2">Backend & Cloud Operations</h4>
                <p className="text-xs text-slate-400 leading-relaxed">
          ...
          <div className="space-y-6">
            ...
            <div className="glass-card p-6 rounded-3xl border border-slate-800 space-y-4">
              <h3 className="text-lg font-bold text-slate-100 pb-3 border-b border-slate-800 flex items-center gap-2">
                <FaUserCheck className="text-cyan-400" /> Key Details
              </h3>
              ...
              <div className="space-y-3 text-xs sm:text-sm">
                ...
                <div>
                  ...
                  <a href={`mailto:${EMAIL}`} className="text-cyan-400 hover:underline break-all font-mono">
                    {EMAIL}
                  </a>
                </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 text-xs font-mono mt-1">
                    <a href={TEL_MY} className="text-slate-200 hover:text-cyan-300 bg-slate-900 px-2.5 py-1 rounded border border-slate-800">
                      +60 17-949-0797
                    </a>
                    <a href={TEL_ID} className="text-slate-200 hover:text-cyan-300 bg-slate-900 px-2.5 py-1 rounded border border-slate-800">
                      +62 812-2148-3613
                    </a>
                  </div>
                </div>
            ...
            <div className="glass-card p-6 rounded-3xl border border-slate-800">
              <h3 className="text-lg font-bold text-slate-100 mb-3 flex items-center gap-2">
                <FaGraduationCap className="text-indigo-400 text-xl" /> Education
              </h3>
              <div>
                ...
                <p className="text-xs text-cyan-400 font-mono mt-1">Bandung, Indonesia • Jan 2016 – Nov 2019</p>
              </div>
            </div>
            ...
            <div className="glass-card p-6 rounded-3xl border border-slate-800">
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-lg font-bold text-slate-100 flex items-center gap-2">
                  <FaCertificate className="text-purple-400 text-lg" /> Certifications
                </h3>
              </div>
              ...
              <a
                ...
                className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-purple-950/80 hover:bg-purple-900/80 text-purple-300 border border-purple-500/40 text-xs font-semibold transition-all shadow-sm"
              >
