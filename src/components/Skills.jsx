...
const Skills = () => {
  return (
    <div
      name="skills"
      className="w-full h-full h-screen bg-[#0a192f] text-gray-300 py-24 "
    >
      {/* container */}
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8">
          ...
          <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500">
            <img className="w-50 mx-auto max-h-24" src={TS} alt="HTML icon" />
          ...
          <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500">
            <img className="w-50 mx-auto" src={Blade} alt="HTML icon" />
            <p className="my-4">Laravel (Blade) </p>
          </div>
          <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500">
            <img className="w-50 mx-auto" src={Redux} alt="HTML icon" />
            <p className="my-4">Redux </p>
          </div>
          <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500">
            <img className="w-50 mx-auto" src={Bootstrap} alt="HTML icon" />
